...
@section('admin_area')
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="{{URL::to('/okAdminShod/course/add')}}">افزودن درس</a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>افزودن درس </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{URL::to('/okAdminShod/course/save')}}" method="POST"  enctype="multipart/form-data">
							{{csrf_field()}}
						  <fieldset>
							  ...
							  <div class="control-group">
								  ...
								  <div class="controls">
									  <input type="number" name="course_unit" id="course_unit">
								  </div>
							  </div>
							<div class="control-group">
